...
- 概念的明确视为概念的约束，使得概念只能表示概念明确后的内容。比如，概念是手机，概念的明确是维修，那么概念就只能表示维修手机，而不能表示手机。
- 输入概念为最外层概念，内层全部视为为父概念和父概念的父概念，以此类推。
- 父概念是子概念的上级概念，视为子概念的超集，输出需要考虑到父概念的内容限制。比如，父概念是维修，输入概念是手机，输出概念就不能是苹果手机，因为它是手机的子集但是和维修没有直接关连，而可以是维修苹果手机。
- 以下要求所指“概念”是指最外层概念。
